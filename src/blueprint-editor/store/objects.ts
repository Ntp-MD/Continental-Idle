...
import { selectedObject, selectedObjectIds, clearSelection } from './selection'
...
export function dissolveGroupsIfSmall(floor: FloorData, groupIds: ReadonlySet<string>): void {
