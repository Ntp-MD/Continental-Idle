    ...
    <div class="originpanel__section">
      ...
      <div class="form__row">
        ...
        <div class="form__row">
          ...
          <button type="button" :class="{ 'flag--active': assetColorSync }" :aria-pressed="assetColorSync" :title="assetColorSync ? 'Outline follows Fill - ON' : 'Outline follows Fill - OFF'" @click="assetColorSync = !assetColorSync">
            <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" />
              <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />
            </svg>
