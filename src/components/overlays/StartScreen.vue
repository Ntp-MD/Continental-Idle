    ...
    <div v-else class="start__content">
      ...
      <aside class="start__panel">
        ...
        <div class="start__actions">
          <button class="btn__warning" @click="startGame">
            START NEW GAME
          </button>

          <button class="btn__success" @click="quickStart">
            QUICK START + AI AUTOPLAY
          </button>

          <button v-if="gameState.hasSave()" class="btn__success" @click="continueGame">
            CONTINUE SAVED GAME
          </button>
