...
export const STAFF_TYPES: StaffDefinition[] = [
  { id: 'concierge', name: 'Concierge', hireCost: 1000, unlock: 'start', maxLevel: 20, effectPerLevel: 0.10, bestMatch: ['reception', 'guestRooms', 'vip'], maxAbility: 'Auto-collect guest tips (+5% passive income)' },
  { id: 'bartender', name: 'Bartender', hireCost: 3000, unlock: 'bar', maxLevel: 20, effectPerLevel: 0.10, bestMatch: ['bar'], maxAbility: 'Bar income continues during excommunicado' },
  { id: 'chef', name: 'Chef', hireCost: 8000, unlock: 'kitchen', maxLevel: 15, effectPerLevel: 0.15, bestMatch: ['kitchen'], maxAbility: 'Kitchen boosts ALL building income by +10%' },
  { id: 'cleaner', name: 'Cleaner', hireCost: 15000, unlock: 'underground', maxLevel: 15, effectPerLevel: 0.05, bestMatch: ['underground', 'laundry'], maxAbility: 'All negative event penalties negated' },
