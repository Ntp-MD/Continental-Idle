...
export const STAFF_TYPES: StaffDefinition[] = [
  ...
  { id: 'cleaner', name: 'Cleaner', hireCost: 15000, unlock: 'underground', maxLevel: 15, effectPerLevel: 0.05, bestMatch: ['underground'], maxAbility: 'All negative event penalties negated' },
