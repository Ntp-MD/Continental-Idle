...
| Hotel floor plans (hand-authored or generated): architect + real-people perspective, scale, placement, circulation/egress, generator checklist | `docs/skill/key-design.md` |
| Editor UI (`src/blueprint-editor/`): markup, CSS, classes, component patterns, BEM, cascade | `docs/skill/ui-layout.md` |
